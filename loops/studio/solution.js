...
while (numMeals < 1 || numMeals > 6 || numMeals === NaN) {
  numMeals = input.question("Number must be greater than 0 and less than 7: ")
}
  return numMeals;
}
...
let maxLength = string1.length;
if (maxLength < string2.length){
